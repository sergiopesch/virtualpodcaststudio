diff --git a//dev/null b/AGENT.md
index 0000000000000000000000000000000000000000..51145003a003236cc90bfa856cf24bcffb77df74 100644
--- a//dev/null
+++ b/AGENT.md
@@ -0,0 +1,109 @@
...
+- **Pages**:
+  - `src/app/page.tsx` – Research Hub: accessible topic toggles backed by a memoized `Set`, abortable fetch workflow, paper transformation helpers, and interactive card actions.【F:podcast-studio/src/app/page.tsx†L125-L466】
...
+
+- **Coordinate schema changes**: If you alter `Paper` fields in the backend, update the Next.js proxy route and UI card rendering simultaneously so `transformPapers` and the card view stay aligned.【F:backend/main.py†L52-L87】【F:podcast-studio/src/app/page.tsx†L93-L210】
