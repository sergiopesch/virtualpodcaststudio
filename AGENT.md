...
- **Next.js 15 frontend (`podcast-studio/`)** that renders the multi-stage production interface (research hub, audio studio, video studio, library, publisher) and exposes Node-powered API routes for realtime OpenAI conversations.【F:podcast-studio/src/app/page.tsx†L1-L213】【F:podcast-studio/src/app/studio/page.tsx†L1-L209】
...
1. **Research discovery** – Frontend `POST /api/papers` → Next proxy route → FastAPI `/api/papers` → arXiv Atom feed → deduped & sorted list back to UI cards.【F:podcast-studio/src/app/api/papers/route.ts†L1-L61】【F:backend/main.py†L206-L323】
...
- **Pages**:
  - `src/app/page.tsx` – Research Hub: topic selection grid, fetch controls, paper cards.【F:podcast-studio/src/app/page.tsx†L1-L213】
  - `src/app/studio/page.tsx` – Audio Studio: WebRTC connect workflow, PCM16 microphone upload, live transcript/chat rendering, export controls.【F:podcast-studio/src/app/studio/page.tsx†L1-L318】【F:podcast-studio/src/app/studio/page.tsx†L600-L1013】
...
- **Coordinate schema changes**: If you alter `Paper` fields in the backend, update the Next.js proxy route and UI card rendering simultaneously to avoid runtime errors.【F:backend/main.py†L52-L87】【F:podcast-studio/src/app/page.tsx†L38-L127】
